...
// 스크린샷 저장 디렉토리 설정
const screenshotDir = "./images/어학";
if (!fs.existsSync(screenshotDir)) {
    fs.mkdirSync(screenshotDir, { recursive: true }); // 디렉토리가 없으면 생성
}
...
async function opicVerify(item, delayTime) {
    ...
    try {
        ...
        // 페이지 전체 스크린샷 저장
        // const resultScreenshotPath = path.join(screenshotDir, `${item.name}_opic_full_result.png`);
